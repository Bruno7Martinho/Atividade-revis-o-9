...
>Descrição: Controlar o progresso de leitura de um livro. Criando Setters e Getters, método para atualizar o número de páginas lidas (não ultrapassando o
total), método para exibir o progresso da leitura (em porcentagem) e método para indicar se a leitura está completa.
## 📌 Sobre o Projeto
